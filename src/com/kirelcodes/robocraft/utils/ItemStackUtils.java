...
import static com.kirelcodes.robocraft.utils.NMSClassInteracter.asBukkitCopy;
import static com.kirelcodes.robocraft.utils.NMSClassInteracter.asNMSCopy;
...
public class ItemStackUtils {
	...
	public static ItemStack addLore(ItemStack item , String...lore){
		...
		List<String> loreList = im.hasLore() ? im.getLore() : new ArrayList<>();
		for(String s : lore)
			loreList.add(s);
		im.setLore(loreList);
		item.setItemMeta(im);
